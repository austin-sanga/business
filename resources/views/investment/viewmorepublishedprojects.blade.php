...
<div class="row">
    ...
    <div class="col"><h5 class="text-center pt-3 me-5" style="color:#0B9050 ">Published projects</h5></div>
</div>
...
<div class="container pt-4 bg-white" >
    ...
    <div class="px-3 ">
        ...
        <div class="row ">
        <div class="col"><span>{{ $published->name }}</span></div>
        <div class="col  justify-content-end text-end"><span>{{ $formatted_money($published->budget) }}</span></div>
        </div>
        </a>
        <hr>
        @endforeach
